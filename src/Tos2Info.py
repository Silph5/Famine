...
roleAliases = {
    ...
    "sher": "sheriff",
    ("soc", "soci"): "socialite",
    ("tav", "tavern_keeper"): "tavernkeeper",
    "track": "tracker",
    "trap": "trapper",
    "trick": "trickster",
    "vet": "veteran",
    ("vig", "vigi"): "vigilante",
    "conj": "conjurer",
    ("cl", "cov", "leader", "coven_leader"): "covenleader",
    "cult": "cultist",
    ...
    ("famine", "fam"): "baker",
    ("war", "bers"): "berserker",
    ("cs", "soul", "wanderingsoul", "cursed", "cursed_soul", "wandering_soul"): "cursedsoul",
    "doom": "doomsayer",
    ("exe", "exec"): "executioner",
    ("jest", "clown"): "jester",
    "pir": "pirate",
    ("plague", "pb", "pest", "pestilence"): "plaguebearer",
    ("sk", "serial_killer"): "serialkiller",
    "shrond": "shroud",
    ("sc", "death", "soul_collector"): "soulcollector",
    ("ww", "were"): "werewolf",
    "vamp": "vampire"
}
